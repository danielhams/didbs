...
#MAKEINFO=missing
export CC CXX CPPFLAGS CFLAGS CXXFLAGS LDFLAGS SHELL SHELL_PATH CONFIG_SHELL MAKE PERL PERL_PATH PATH GBS8_1_INSTALL_DIR GBS9_0_INSTALL_DIR MAKEINFO
if [ "ne$DIDBS_LIBDIR" == "nelib32" ]; then
    LD_LIBRARYN32_PATH="$GBS9_0_INSTALL_DIR/$DIDBS_LIBDIR:$GBS8_1_INSTALL_DIR/$DIDBS_LIBDIR:$INSTALLDIR/lib32"
    PKG_CONFIG_PATH="$INSTALLDIR/lib32/pkgconfig"
    export LD_LIBRARYN32_PATH PKG_CONFIG_PATH
else
    LD_LIBRARYN64_PATH="$GBS9_0_INSTALL_DIR/$DIDBS_LIBDIR:$GBS8_1_INSTALL_DIR/$DIDBS_LIBDIR:$INSTALLDIR/lib64"
