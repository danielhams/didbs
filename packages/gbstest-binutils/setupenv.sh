...
SHELL_PATH="$SHELL"
CONFIG_SHELL="$SHELL"
MAKE="$GBSTEST_INSTALL_DIR/bin/make"
...
export CC CFLAGS LDFLAGS SHELL SHELL_PATH CONFIG_SHELL MAKE PERL PERL_PATH PATH LD_LIBRARYN32_PATH LD_LIBRARY_PATH PKG_CONFIG_PATH GBS1_INSTALL_DIR GBSTEST_INSTALL_DIR
