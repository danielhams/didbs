...
MAKEINFO=missing
STAGE1_CFLAGS="-O2"
export CC CXX CPPFLAGS CFLAGS CXXFLAGS LDFLAGS SHELL CONFIG_SHELL SHELL_PATH PERL PERL_PATH GBS8_1_INSTALL_DIR GBS9_0_INSTALL_DIR PATH MAKEINFO STAGE1_CFLAGS
