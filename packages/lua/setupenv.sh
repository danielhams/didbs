...
#CFLAGS="$DIDBS_MP_CPPFLAGS $DIDBS_ISA_SWITCH -g -O2 -I$INSTALLDIR/include -I$INSTALLDIR/include/libdicl-0.1"
...
DIDBS_LUA_CC="$CC"
DIDBS_LUA_CFLAGS="$CFLAGS"
DIDBS_LUA_LDFLAGS="$LDFLAGS"
export DIDBS_LUA_CC DIDBS_LUA_CFLAGS DIDBS_LUA_LDFLAGS
