...
LD_LIBRARY_PATH="$GBS8_1_INSTALL_DIR/lib:$LD_LIBRARY_PATH"
export CC CXX CPPFLAGS CFLAGS CXXFLAGS LDFLAGS SHELL CONFIG_SHELL SHELL_PATH PERL PERL_PATH GBSTEST_INSTALL_DIR GBS8_1_INSTALL_DIR LD_LIBRARYN32_PATH LD_LIBRARY_PATH PATH
