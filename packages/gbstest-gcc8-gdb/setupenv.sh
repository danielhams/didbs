...
export CC CXX CPPFLAGS CFLAGS CXXFLAGS LDFLAGS SHELL CONFIG_SHELL SHELL_PATH PERL PERL_PATH GBSTEST_INSTALL_DIR LD_LIBRARYN32_PATH LD_LIBRARY_PATH PATH
