...
config_args='-Dprefix=/tmp/perlinst -Dusethreads'
config_argc=2
config_arg1='-Dprefix=/tmp/perlinst'
...
ar='ar'
archlib='/tmp/perlinst/lib/5.28.2/IP30-irix-thread-multi'
archlibexp='/tmp/perlinst/lib/5.28.2/IP30-irix-thread-multi'
archname64=''
...
baserev='5.0'
bash=''
bin='/tmp/perlinst/bin'
bin_ELF='define'
binexp='/tmp/perlinst/bin'
bison='bison'
byacc='byacc'
byteorder='4321'
c=''
...
cat='cat'
cc='c99'
cccdlflags='-KPIC -shared'
ccdlflags='  -Wl,-rpath,/tmp/perlinst/lib/5.28.2/IP30-irix-thread-multi/CORE'
ccflags='-DPTHREAD_H_FIRST -D_SGI_SOURCE -D_SGI_MP_SOURCE -D_SGI_REENTRANT_FUNCTIONS -DLANGUAGE_C -woff 1184,1552,3970 -I/builds/dan/bootstrapinstall/include'
ccflags_uselargefiles=''
ccname='c99'
ccsymbols='_ABIN32=2 _MIPS_SIM=_ABIN32 _SGI_COMPILER_VERSION=744 __c99=1'
ccversion=''
cf_by='dan'
...
cppflags='-DPTHREAD_H_FIRST -D_SGI_SOURCE -D_SGI_MP_SOURCE -D_SGI_REENTRANT_FUNCTIONS -DLANGUAGE_C -woff 1184,1552'
cpplast='-'
cppminus='-'
cpprun='c99  -E'
cppstdin='c99  -E'
...
full_ar='/usr/bin/ar'
full_csh='/sbin/csh'
full_sed='/builds/dan/bootstrapinstall/bin/sed'
gccansipedantic=''
gccosandvers=''
gccversion=''
...
incpth='/usr/include'
inews=''
initialinstalllocation='/tmp/perlinst/bin'
installarchlib='/tmp/perlinst/lib/5.28.2/IP30-irix-thread-multi'
installbin='/tmp/perlinst/bin'
installhtml1dir=''
installhtml3dir=''
installman1dir=''
installman3dir=''
installprefix='/tmp/perlinst'
installprefixexp='/tmp/perlinst'
installprivlib='/tmp/perlinst/lib/5.28.2'
installscript='/tmp/perlinst/bin'
installsitearch='/tmp/perlinst/lib/site_perl/5.28.2/IP30-irix-thread-multi'
installsitebin='/tmp/perlinst/bin'
installsitehtml1dir=''
installsitehtml3dir=''
installsitelib='/tmp/perlinst/lib/site_perl/5.28.2'
installsiteman1dir=''
installsiteman3dir=''
installsitescript='/tmp/perlinst/bin'
installstyle='lib'
...
lddlflags='-shared -O3 -OPT:Olimit=0:space=ON -L/builds/dan/bootstrapinstall/lib'
ldflags='-Wl,-woff,84 -L/builds/dan/bootstrapinstall/lib'
...
libperl='libperl.so'
libpth='/builds/dan/bootstrapinstall/lib /usr/lib32 /lib32 /lib /usr/lib'
libs='-lc -lpthread -ldb -lm'
libsdirs=' /usr/lib32 /builds/dan/bootstrapinstall/lib'
...
libsfound=' /usr/lib32/libcl.so /usr/lib32/libpthread.so /usr/lib32/libsocket.so /usr/lib32/libnsl.so /builds/dan/bootstrapinstall/lib/libdb.so /usr/lib32/libmalloc.so /usr/lib32/libdl.so /usr/lib32/libsun.a /usr/lib32/libm.so /usr/lib32/libcrypt.so /usr/lib32/libc.so /usr/lib32/libbsd.a'
libspath=' /builds/dan/bootstrapinstall/lib /usr/lib32 /lib32 /lib /usr/lib'
...
lkflags=''
ln='ln'
lns='/builds/dan/bootstrapinstall/bin/ln -s'
...
otherlibdirs=' '
package='perl5'
pager='/builds/dan/bootstrapinstall/bin/less -R'
passcat='cat /etc/passwd'
patchlevel='28'
path_sep=':'
perl5='/builds/dan/bootstrapinstall/bin/perl'
perl='perl'
perl_patchlevel=''
perl_static_inline='static inline'
perladmin='dan@leafy.modular-audio.co.uk'
perllibs='-lc -lpthread -lm'
perlpath='/tmp/perlinst/bin/perl'
pg='pg'
phostname='hostname'
pidtype='pid_t'
...
pr=''
prefix='/tmp/perlinst'
prefixexp='/tmp/perlinst'
privlib='/tmp/perlinst/lib/5.28.2'
privlibexp='/tmp/perlinst/lib/5.28.2'
procselfexe=''
ptrsize='4'
quadkind='3'
quadtype='long long'
...
revision='5'
rm='rm'
rm_try='/builds/dan/bootstrapinstall/bin/rm -f try try a.out .out try.[cho] try..o core core.try* try.core*'
rmail=''
run=''
runnm='true'
...
scriptdir='/tmp/perlinst/bin'
scriptdirexp='/tmp/perlinst/bin'
sed='sed'
...
sig_size='69'
signal_t='void'
sitearch='/tmp/perlinst/lib/site_perl/5.28.2/IP30-irix-thread-multi'
sitearchexp='/tmp/perlinst/lib/site_perl/5.28.2/IP30-irix-thread-multi'
sitebin='/tmp/perlinst/bin'
sitebinexp='/tmp/perlinst/bin'
sitehtml1dir=''
sitehtml1direxp=''
sitehtml3dir=''
sitehtml3direxp=''
sitelib='/tmp/perlinst/lib/site_perl/5.28.2'
sitelib_stem='/tmp/perlinst/lib/site_perl'
sitelibexp='/tmp/perlinst/lib/site_perl/5.28.2'
siteman1dir=''
siteman1direxp=''
siteman3dir=''
siteman3direxp=''
siteprefix='/tmp/perlinst'
siteprefixexp='/tmp/perlinst'
sitescript='/tmp/perlinst/bin'
sitescriptexp='/tmp/perlinst/bin'
sizesize='4'
sizetype='size_t'
sleep=''
smail=''
...
st_ino_sign='1'
st_ino_size='8'
startperl='#!/tmp/perlinst/bin/perl'
startsh='#!/bin/sh'
static_ext=' '
